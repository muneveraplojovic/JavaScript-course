...
// 'You got ${num of products} in cart, shipping cost is ${shipping cost},
//your total is ${total}.'
...
function getTwoPairs(artikli) {
  const parovi = artikli.map((el) => {
    return {
      name: el.name,
...
console.log(getTwoPairs(CART_DATA));
