...
//   const nolanoviFilmovi = arr.filter(function (film) {
//     return film.Director === "Christopher Nolan";
//   });
//   const ocene = nolanoviFilmovi.map(function (element) {
//     return +element.imdbRating;
//   });
//   const brojac = ocene.length;
//   const suma = ocene.reduce(function (prevValue, currValue) {
//     return prevValue + currValue;
//   });
//   const prosek = +(suma / brojac).toFixed(2);
//   return prosek;
// }
